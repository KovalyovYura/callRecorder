...
import static com.yuriyk_israelb.finalProject.MainActivity.contactsDB;
...
public class RecordsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor_all = contactsDB.rawQuery("SELECT  * FROM records ORDER BY _id DESC", null);
        ...
        cursor_in = contactsDB.rawQuery("SELECT  * FROM records WHERE in_out = '1' ORDER BY _id DESC", null);
        ...
        cursor_out = contactsDB.rawQuery("SELECT  * FROM records WHERE in_out = '0' ORDER BY _id DESC", null);
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                if(!s.equals(""))
                {
                    cursor_all = contactsDB.rawQuery("SELECT  * FROM records WHERE name LIKE '%" + s + "%' ORDER BY _id DESC", null);
                    changeCursor(adapter_all, cursor_all);

                    cursor_in = contactsDB.rawQuery("SELECT  * FROM records WHERE in_out = '1' AND name LIKE '%" + s + "%' ORDER BY _id DESC", null);
                    changeCursor(adapter_in, cursor_in);

                    cursor_out = contactsDB.rawQuery("SELECT  * FROM records WHERE in_out = '0' AND name LIKE '%" + s + "%' ORDER BY _id DESC", null);
