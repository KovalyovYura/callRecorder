...
public class SingleRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        record_uri = Uri.fromFile(new File(recordRef));
        mp = MediaPlayer.create(this, record_uri);
...
//        SystemClock.sleep(1000); // wait 1 sec
        Log.d("debug", Integer.toString(mp.getCurrentPosition()));
                ...
                public void run() {
                    while(isPlaying)
                    {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                if(mp.getCurrentPosition()/1000 >= mp.getDuration()/1000)//audio is done
                                {
                                    isPlaying = false;
...
//                    mp.reset();
            ...
            //  add / edit / save Button for Remark
    ...
    private void showDeleteDialog()
    {
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                File f_to_del = new File(record_uri.getPath());
                if(f_to_del.exists())
                    f_to_del.delete();
